...
# colnames(st_libStats_x) <- gsub("Uniquely mapped reads (M)",
#                                 "Uniquely mapped reads (M)",
#                                 colnames(st_libStats_x),
#                                 fixed = TRUE)
