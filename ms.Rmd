...
Two G1-Like (ALOG) genes, *G1L2* and *G1L5* (*TAWAWA*), were present in clusters `r getClusterName('dec', 'small')` and `r getClusterName('dec', 'dec')` respectively. Only three ALOG genes are expressed in the meristem RNA sequencing dataset, but they share a similar expression pattern (`r I(pasteLabel("Figure ", figCount, "f_alogFamily"))`). *G1L5* mutants **do what, incl. ref**, and the co-expression of other ALOG genes suggests redundancy within the family.
