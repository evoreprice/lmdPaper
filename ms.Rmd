...
`r capwords(as.character(english::english(c)))` common patterns of expression were recovered from the normalised, variance-stabilised read counts. Genes expressed in blah blah
