...
*log1* mutants also appear to have reduced expression of the *HOMEOBOX 1* (*OSH1*) gene [@Kurakawa:2007go], which encodes a class I *Knotted1-like homeobox* (*KNOX*) homeodomain transcription factor. *osh1* mutants have defects in SAM maintenance during vegetative growth and lower expression of other *KNOX* genes, and expression of *KNOX* genes can be induced by cytokinin treatment during shoot regeneration [@Tsuda:2011gz]. In *A. thaliana*, cytokinin increases the production of the homeodomain gene *WUSCHEL*, which itself enhances cytokinin signalling [**ref Leibfried 2005**; **ref Lindsay, 2006**; @Gordon:2009fp]. **Can expand this section**.

Three class IV HD-Zip genes, *RICE OUTMOST CELL-SPECIFIC GENE 1* (*ROC1*), *ROC3* and *LOC_Os09g35760*, were found in cluster `r getClusterName('inc', 'small')`, containing genes that had lowest expression in the RM and higher expression in the samples from axillary meristems. Examining the dynamics of expression of all homeobox genes revealed that a prominent group follow a similar pattern, including five of the eight detected class IV HD-Zip genes and several genes from other homeobox subclasses, including *OSH1*. **Anything about functions of these genes?** There are also smaller groups of homeobox genes that peak in expression in the SM or RM samples, suggesting multiple roles and possible redundancy for homeodomain proteins during inflorescence development. **Can expand this section**.
