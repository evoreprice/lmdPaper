...
Homeodomain genes are involved at various stages of plant development and in several hormone response pathways (**ref Chan 1998**; **ref Himmelbach 2002**; **ref Sawa 2002**). The expression of this family in inflorescence meristems was explored in greater detail using a heatmap of scaled, transformed read counts. Heirarchical clustering of the transformed counts recovered five prominent groups of expression,  with unequal distribution of subfamilies of homeodomain genes among the groups (`r I(pasteLabel("Figure ", figCount, "f_hb"))`).
