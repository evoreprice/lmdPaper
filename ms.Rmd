...
**`r I(pasteLabel("Figure S", s_figCount, "sf_inSitu"))`**: RNA *in situ* hybridization analysis to confirm the specific expression patterns of four genes detected in the RNA sequencing dataset.
...
**`r I(pasteLabel("Figure ", figCount, "f_lmdFigure"))`**. Laser microdissection of meristem samples in the early stages of inflorescence development. Samples were collected from the rachis meristem (**a** and **e**), the primary branch meristem (**b** and **f**), the elongating primary branch meristem and axillary meristem (**c** and **g**) and the spikelet meristem (**d** and **h**). Images show the samples before (**a**–**d**) and after (**e**–**h**) dissection. Scale bars represent 200 µm (red, **a**–**c** and **e**–**g**) or 320 µm (blue, **d** and **h**).
...
**`r I(pasteLabel("Figure ", figCount, "f_alogFamily"))`**. Expression of selected genes in the RNAseq dataset in transcripts per million (TPM). A red point indicates that the gene was above the detection cutoff, and blue indicates that the gene was not detected. (**a**) Two reported *STMADS11*-like (*SVP*-like) targets of G1L5, *MADS22* and *MADS55* [@Yoshida:2013ff], are more strongly expressed in the RM than in other meristems, and the other *STMADS11*-like gene, *MADS47*, was only detected in one library. (**b**) Only three ALOG genes (*G1L1*, *G1L2* and *G1L5*/*TAWAWA1*) were detected, and they share a similar pattern of expression. (**c**) Several *SPL* genes and a co-regulated microRNA precursor, *MIR319A*, which was recovered in cluster `r getClusterName('small', 'dec')`, are highly expressed in RM and PBM before decreasing in expression in ePBM/AM and SM. (**d**) *GN1A* (*CKX2*) was not detected in the LMD dataset, but *LOG1* is expressed in all meristem types, and two other genes possibly related to cytokinin activation, *LABA1* (*LOGL6*) and *LOGL1*, are expressed more highly in ePBM/AM and SM than in RM and PBM. 
