...
**`r I(pasteLabel("Figure ", figCount, "f_alogFamily"))`**. Expression of rice G1/ALOG family genes in inflorescence meristems. Genes were retrieved by querying Phytozome 10.3 for the Pfam domain PF04852 [@Goodstein:2012ho] (**ref: Pfam**). Red or blue points indicate whether the gene was detected or not detected respectively for each library. Only three G1 genes (*G1L1*, *G1L2* and *G1L5*/*TAWAWA*) were detected, but they share a similar pattern of expression.
